...
## Project Structure
    ...
    ├── testapiautoteammemb_85498  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_85498`
...
2. Clone this repo and `cd testapiautoteammemb_85498`
